此库是一个临时展示与修改库，利用github page托管静态网站，主要方便多人协同和初学修改，另外就经费与项目目的来看不太可能开服务器所以也不会用VPS，AWS等平台或者docker和Kubernetes这类工具，此外如果大家想自己搞一个网站（在已经有服务器的情况下）可以套模板或者教程利用我之前提到的平台和工具来便捷的部署，为之后的学习工作助力。
